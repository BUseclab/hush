...
package edu.bu.android.hiddendata.parser;
...
public class SignatureParser {
    ...
    public static void main(String[] args){
    	SignatureParser sp = new SignatureParser();
    	String s ="<K:Ljava/lang/Object;V:Ljava/lang/Object;>Ljava/lang/Object;Lcom/github/wil3/android/flowtests/Pair<TK;TV;>;";
    	ClassSignature cs = sp.parseClassSig(s);
    	System.out.println("");
    }
 }
